...
This is a sample template for artfario-importer - Below is a brief explanation of what we have generated for you:
...
```bash
aws cloudformation delete-stack --stack-name artfario-importer
```
